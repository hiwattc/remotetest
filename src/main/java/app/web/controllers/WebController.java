...
public class WebController {
	...
	@GetMapping("/ps1")
    public String ps1() throws IOException {
    	String[] cmd = new String[]{"/bin/sh", "ps -ef|grep java"};
        return execCommand(cmd);
    }
	@GetMapping("/netstat1")
    public String netstat1() throws IOException {
    	String[] cmd = new String[]{"/bin/sh","netstat -an"};
        return execCommand(cmd);
    }
	@GetMapping("/topas")
    public String topas() throws IOException {
    	String[] cmd = new String[]{"/bin/sh","topas"};
        return execCommand(cmd);
    }
